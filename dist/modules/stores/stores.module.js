...
const store_service_entity_1 = require("./entities/store-service.entity");
...
exports.StoresModule = StoresModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([store_entity_1.Store, store_service_entity_1.StoreService, port_entity_1.Port, service_type_entity_1.ServiceType])],
